          ...
          <div class="card-body border-bottom py-3">
            <div class="d-flex">
              <div class="text-muted">
                Search:
                <form action="index.php?i=pesanan" method="POST" class="ms-md-2 d-inline-block">
              ...
              <tbody>
                ...
                ?>
                    <tr>
                      ...
                      <td data-label="TRX ID"><a href="index.php?i=pesanan-detail&id=<?= $data[0] ?>" class="text-reset"><?= $data[1] ?></a></td>
                      <td data-label="Nama User"><a href="index.php?i=user-detail&id=<?= $data[5] ?>" class="text-reset"><?= $data[2] ?></td>
                      ...
                      <td data-label="Action">
                        <div class="btn-list justify-content-md-end flex-nowrap">
                          <a href="index.php?i=pesanan-detail&id=<?= $data[0] ?>" class="btn btn-outline-success">
                            Detail
                          </a>
                          <a href="index.php?i=pesanan-edit&id=<?= $data[0] ?>" class="btn btn-outline-primary">
                            Edit
                          </a>
                        </div>
                      </td>
