  ...
  <div class="page-header d-print-none">
    <div class="row align-items-center">
      ...
      <div class="col-auto ms-auto d-print-none">
        <div class="btn-list">
          <a href="index.php?i=brandzproduk-tambah" class="btn btn-primary d-none d-sm-inline-block">
          ...
          <a href="index.php?i=brandzproduk-tambah" class="btn btn-primary d-sm-none btn-icon" aria-label="Tambah Brand Produk">
            <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path stroke="none" d="M0 0h24v24H0z" fill="none" />
              <line x1="12" y1="5" x2="12" y2="19" />
          ...
          <div class="card-body border-bottom py-3">
            <div class="d-flex">
              <div class="text-muted">
                Search:
                <form action="index.php?i=brandzproduk" method="POST" class="ms-md-2 d-inline-block">
              ...
              <tbody>
                ...
                ?>
                    <tr>
                      ...
                      <td data-label="Brand Produk"><a href="index.php?i=brandzproduk-edit&id=<?= $id_brand ?>" class="text-reset" tabindex="-1"><?= $nama_brand ?></a></td>
                      <td data-label="Action">
                        <div class="btn-list justify-content-md-end flex-nowrap">
                          <a href="index.php?i=brandzproduk-edit&id=<?= $id_brand ?>" class="btn btn-outline-primary">
                            Edit
                          </a>
