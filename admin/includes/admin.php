  ...
  <div class="page-header d-print-none">
    <div class="row align-items-center">
      ...
      <div class="col-auto ms-auto d-print-none">
        <div class="btn-list">
          <a href="index.php?i=admin-tambah" class="btn btn-primary d-none d-sm-inline-block">
          ...
          <a href="index.php?i=admin-tambah" class="btn btn-primary d-sm-none btn-icon" aria-label="Tambah Admin">
            <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path stroke="none" d="M0 0h24v24H0z" fill="none" />
              <line x1="12" y1="5" x2="12" y2="19" />
                    ...
                    <tr>
                      ...
                      <td data-label="Admin">
                        <div class="d-flex align-items-center py-1">
                          ...
                          <a href="index.php?i=admin-detail&id=<?= $data[0] ?>" class="flex-fill text-reset">
                      ...
                      <td data-label="Action">
                        <div class="btn-list justify-content-md-end flex-nowrap">
                          <a href="index.php?i=admin-detail&id=<?= $data[0] ?>" class="btn btn-outline-success">
                            Detail
                          </a>
                          <a href="index.php?i=admin-edit&id=<?= $data[0] ?>" class="btn btn-outline-primary">
                            Edit
                          </a>
